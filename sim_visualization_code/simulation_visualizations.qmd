...
data_10_rep <- TTT_10_rep |>
  ...
  mutate(technique = fct_relevel(technique, "Loess Adjusted Fit (Reads in Peaks)", after = 8),
         ...
         symm = if_else(symmetry == TRUE, "Symmetric Differential Occupancy",
                        "Asymmetric Differential Occupancy"),
         symm = fct_relevel(symm, "Symmetric Differential Occupancy"),
         dna = if_else(equal.DNA.bind == TRUE, "Equal DNA Occupancy", 
                       "Unequal DNA Occupancy"),
         back = if_else(constant.background == TRUE, "Equal Background Binding",
                        "Unequal Background Binding")) 
...
data_10_rep |>
  ...
  geom_hline(aes(yintercept = FDR.threshold))+
  geom_point(aes(color = technique), size = 0.5)+
  geom_line(aes(color = technique, linetype = technique))+
...
ggsave("../png_outputs/all_FDR_10_rep.png", bg = "white", dpi = 1500, width = 13, height = 8, units = "in")
```
...
ggsave("../png_outputs/all_power_10_rep.png", bg = "white", dpi = 2000, width = 13, height = 8, units = "in")
```

```{r all FDR -- 4 rep}
data_4_rep |>
  group_by(prop.do, technique, symm, back, dna, FDR.threshold) |>
  summarize(avg_FDR = mean(FDR, na.rm = TRUE)) |>
...
ggsave("../png_outputs/all_FDR_4_rep.png", bg = "white", dpi = 1500, width = 13, height = 8, units = "in")
```
...
ggsave("../png_outputs/all_power_4_rep.png", bg = "white", dpi = 1500, width = 13, height = 8, units = "in")
```
...
sizefactors_rel_oracle_4 <- data_4_rep |>
  ...
  group_by(technique, symm, dna, back, prop.do, it) |>
  summarize(mean_sizefactor_ratio_it = mean(sizefactor_ratio)) |>
  ungroup() |>
  group_by(technique, symm, dna, back, prop.do) |>
  summarize(mean_sizefactor_ratio_prop.do = mean(mean_sizefactor_ratio_it)) 
...
data_10_rep |>
  ...
  facet_grid(back ~ symm + dna)+
    grafify::scale_color_grafify(palette = "bright", ColSeq = FALSE, reverse = FALSE)+
  grafify::scale_fill_grafify(palette = "bright", ColSeq = FALSE, reverse = FALSE)+
  guides(color = guide_legend(title = "Technique"), 
         linetype = guide_legend(title = "Technique"),
...
ggsave("../png_outputs/CI_FDR_10_rep.png", bg = "white", dpi = 1500, width = 13, height = 8, units = "in")
```
...
ggsave("../png_outputs/CI_power_10_rep.png", bg = "white", dpi = 2000, width = 13, height = 8, units = "in")
```
...
ggsave("../png_outputs/CI_FDR_4_rep.png", bg = "white", dpi = 1500, width = 13, height = 8, units = "in")
```
...
ggsave("../png_outputs/CI_power_4_rep.png", bg = "white", dpi = 1500, width = 13, height = 8, units = "in")
```

### TTT Panels

```{r 1 TTT for 4 and 10 rep}
data_4_rep |>
...
ggsave("../png_outputs/TTT-4-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../png_outputs/TTT-10-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
```

### FTT Panels

```{r 2 FTT for 4 and 10 rep}
data_4_rep |>
  filter(!symmetry & equal.DNA.bind & constant.background) |>
  mutate(power = true_positives/(true_positives + false_negatives)) |>
  group_by(technique, symmetry, symm, equal.DNA.bind, dna, 
...
ggsave("../png_outputs/FTT-4-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../png_outputs/FTT-10-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
```

### TFT Panels

```{r 3 TFT for 4 and 10 rep}
data_4_rep |>
  filter(symmetry & !equal.DNA.bind & constant.background) |>
  mutate(power = true_positives/(true_positives + false_negatives)) |>
  group_by(technique, symmetry, symm, equal.DNA.bind, dna, 
...
ggsave("../png_outputs/TFT-4-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../png_outputs/TFT-10-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
```

### TTF Panels

```{r 4 TTF for 4 and 10 rep}
data_4_rep |>
  filter(symmetry & equal.DNA.bind & !constant.background) |>
  mutate(power = true_positives/(true_positives + false_negatives)) |>
  group_by(technique, symmetry, symm, equal.DNA.bind, dna, 
...
ggsave("../png_outputs/TTF-4-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../png_outputs/TTF-10-rep.png", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
```
