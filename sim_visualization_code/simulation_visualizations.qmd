...
ggsave("../visualization_outputs/all_FDR_10_rep.pdf", bg = "white", dpi = 1500, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/all_FDR_4_rep.pdf", bg = "white", dpi = 1500, width = 15, height = 8, units = "in")
```
### Average Power
...
ggsave("../visualization_outputs/all_power_10_rep.pdf", bg = "white", dpi = 2000, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/all_power_4_rep.pdf", bg = "white", dpi = 1500, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/TTT-4-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/TTT-10-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/FTT-4-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/FTT-10-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/TFT-4-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/TFT-10-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/TTF-4-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/TTF-10-rep.pdf", bg = "white", dpi = 1500, width = 13, height = 7, units = "in")
```
...
ggsave("../visualization_outputs/CI_FDR_10_rep.pdf", bg = "white", dpi = 1500, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/CI_power_10_rep.pdf", bg = "white", dpi = 2000, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/CI_FDR_4_rep.pdf", bg = "white", dpi = 1500, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/CI_power_4_rep.pdf", bg = "white", dpi = 1500, width = 15, height = 8, units = "in")
```
...
ggsave("../visualization_outputs/FFT-4-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../visualization_outputs/FFT-10-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../visualization_outputs/FTF-4-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../visualization_outputs/FTF-10-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
```
...
ggsave("../visualization_outputs/TFF-4-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5)
...
ggsave("../visualization_outputs/TFF-10-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
```
...
ggsave("../visualization_outputs/FFF-4-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
...
ggsave("../visualization_outputs/FFF-10-rep.pdf", bg = "white", dpi = 1500, width = 9, height = 5, units = "in")
