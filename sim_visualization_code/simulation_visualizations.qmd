...
## Metric panels for each simulation condition

```{r dataframe for thresholds}
thresholds <- data.frame(yint = c(0.05, 1, 1),
                         metric = c("Average FDR",
                                    "Average Power",
                "Average Absolute\nSize Factor Ratio,\nRelative to the Oracle")) |>
  mutate(metric = 
           fct_relevel(metric, "Average Absolute\nSize Factor Ratio,\nRelative to the Oracle", after = Inf))
```
